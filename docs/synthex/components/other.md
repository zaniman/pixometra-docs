...
Review the [Colors](/synthex/components/colors) and [Typography](/synthex/components/typography) sections to finalize your design system, then:

→ [Publish Your Site](/synthex/components/publish)
