...
2. Check mobile responsiveness (use responsive preview)
3. Test all links work
4. Review all pages are complete
...
Framer will:
- Build your site
- Deploy to Framer's CDN
- Provide you with a subdomain URL

Your site is **live immediately** at something like:
```
